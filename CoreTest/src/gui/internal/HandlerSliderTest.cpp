...
namespace core::gui
{
	...
	public:
		TEST_METHOD(HandlerSliderButton_actionIncrement)
		{
			...
			HandlerSlider root{ [&counter]() { counter = 4; }, { 0.0f, 5.0f, 2.5f, 0.1f } };
		...
		TEST_METHOD(HandlerSliderButton_actionDecrement)
		{
			...
			widget.m_family.m_parent = &parent;
			HandlerSlider root{ [&counter]() { counter = 9; }, { 0.0f, 5.0f, 2.5f, 0.1f } };
		...
		TEST_METHOD(HandlerSliderBar_processHorizontal)
		{
			...
			HandlerSlider root{ [&counter]() { counter = 5; }, { 0.0f, 10.0f, 9.0f, 0.1f } };
